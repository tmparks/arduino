...
void printConfiguration() {
    ...
    Serial.print("PM25_GOOD = ");
    Serial.println(PM25_GOOD);
    Serial.print("PM25_MODERATE = ");
    Serial.println(PM25_MODERATE);
    Serial.print("PM25_UNHEALTHY_SENSITIVE = ");
    Serial.println(PM25_UNHEALTHY_SENSITIVE);
    Serial.print("PM25_UNHEALTHY = ");
    Serial.println(PM25_UNHEALTHY);
    Serial.print("PM25_VERY_UNHEALTHY = ");
    Serial.println(PM25_VERY_UNHEALTHY);
    Serial.print("PM25_SLEEP_BEGIN_HOUR = ");
    Serial.println(PM25_SLEEP_BEGIN_HOUR);
    Serial.print("PM25_SLEEP_END_HOUR = ");
    Serial.println(PM25_SLEEP_END_HOUR);
    Serial.print("PM25_WAKE_MINUTES = ");
    Serial.println(PM25_WAKE_MINUTES);
    Serial.print("IGNORE_MOTION_SENSOR = ");
    Serial.println(IGNORE_MOTION_SENSOR ? "true" : "false");
    Serial.print("IGNORE_BME688_SENSOR = ");
    Serial.println(IGNORE_BME688_SENSOR ? "true" : "false");
}
...
void setup() {
    ...
    if (IGNORE_MOTION_SENSOR) {
        ...
        radar.setDelay(/*trig*/ 10,
                       /*keep*/ 4); //trig 0.1s :unit 0.01s (0-2s); keep 2s :unit 0.5s (1s-1500s)
